defmodule RumblWeb.VideoController do
  ...
  # modify argument list for our controller actions
  # we inserted the current user to our controller actions
  # the action method is a plug used to access our controllers in phoenix
